...
CREATE TABLE `zakazi` (
  ...
  `zak_ime` varchar(45) NOT NULL,
  `zak_prezime` varchar(45) NOT NULL,
  `zak_vreme` time DEFAULT NULL,
  `zak_datum` date DEFAULT NULL,
  PRIMARY KEY (`zak_id`)
...
INSERT INTO `zakazi` VALUES (1,'Milos','Stankovic','15:50:00','2021-01-14');
