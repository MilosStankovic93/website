...
CREATE TABLE `pacijenti` (
  ...
  `ime_pac` varchar(45) DEFAULT NULL,
  `prezime_pac` varchar(45) DEFAULT NULL,
  `tel_pac` int DEFAULT NULL,
  `email_pac` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_pac`)
...
INSERT INTO `pacijenti` VALUES (1,'Milos','Stankovic',691313647,'milos@gmail.com'),(2,'Jelena','Novkovic',601313794,'jelena@gmail.com');
