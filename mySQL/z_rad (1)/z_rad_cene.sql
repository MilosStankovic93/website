...
CREATE TABLE `cene` (
  `cena_ime` varchar(50) NOT NULL,
  `cena_cena` varchar(45) DEFAULT NULL,
  `cena_valuta` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`cena_ime`)
...
LOCK TABLES `cene` WRITE;
/*!40000 ALTER TABLE `cene` DISABLE KEYS */;
INSERT INTO `cene` VALUES ('Audioloski trening','2300','RSD'),('Dijagnostika','5800','RSD'),('Konsultacije','8200','RSD'),('Svetlosna terapija','2300','RSD'),('Vibroakusticna terapija','3500','RSD');
